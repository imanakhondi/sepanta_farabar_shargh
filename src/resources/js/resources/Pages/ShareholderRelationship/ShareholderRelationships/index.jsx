...
import { InputDatePickerColumn, InputSelectColumn, InputTextColumn, ListPage, Modal, TableItems } from "../../../components";
...
const ShareholderRelationships = () => {
    ...
    const { shareholderRelationshipsPage: strings, general } = useLocale();
...
export default ShareholderRelationships;
