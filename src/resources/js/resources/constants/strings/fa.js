...
export const addDriverPage = {
  ...
  mobile: "موبایل",
  mobilePlaceholder: "موبایل",
  driverLicenseNum: "شماره گواهینامه راننده",
  driverLicenseNumPlaceholder: "شماره گواهینامه راننده",
  driverSmartCard: "کارت هوشمند راننده",
  driverSmartCardPlaceholder: "کارت هوشمند راننده",
  email: "پست الکترونیک",
  emailPlaceholder: "پست الکترونیک",
  password: "کلمه عبور",
  passwordPlaceholder: "کلمه عبور",
...
export const addCarPage = {
  ...
  nationalCode: "کد ملی مالک",
  nationalCodePlaceholder: "کد ملی مالک",
  mobile: "موبایل مالک",
  mobilePlaceholder: "موبایل مالک",
  carLicensePlateNum: "شماره پلاک شهربانی ماشین",
  carLicensePlateNumPlaceholder: "شماره پلاک شهربانی ماشین",
  carTransitLicensePlateNum: "شماره پلاک ترانزیت ماشین",
  carTransitLicensePlateNumPlaceholder: "شماره پلاک ترانزیت ماشین",
  CLPN1Placeholder: "- -",
  CLPN2Placeholder: "ع",
  CLPN3Placeholder: "- - -",
  CLPN4Placeholder: "- -",
